/****************************************************************************************
 * AGENT + TOOL SETUP WITH USER CONTEXT + STRUCTURED OUTPUT (PRODUCTION SAFE)
 * --------------------------------------------------------------------------------------
 * Architecture:
 * Phase 1 → Agent reasons + calls tools (TEXT)
 * Phase 2 → Formatter converts text → structured JSON (Zod enforced)
 ****************************************************************************************/
